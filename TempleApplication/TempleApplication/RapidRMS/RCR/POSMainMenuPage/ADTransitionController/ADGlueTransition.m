...
- (instancetype)initWithDuration:(CFTimeInterval)duration orientation:(ADTransitionOrientation)orientation sourceRect:(CGRect)sourceRect {
    ...
    outTransformKeyFrameAnimation.timingFunctions = self.circleApproximationTimingFunctions;
    ...
    outAnimation.animations = @[outOpacityKeyFrameAnimation, outTransformKeyFrameAnimation, outAnchorPointAnimation];
