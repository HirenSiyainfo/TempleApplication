...
- (instancetype)initWithDuration:(CFTimeInterval)duration orientation:(ADTransitionOrientation)orientation sourceRect:(CGRect)sourceRect {
    ...
    zTranslationAnimation.timingFunctions = self.circleApproximationTimingFunctions;
    ...
    inAnimation.animations = @[inFlipAnimation, zTranslationAnimation];
    inAnimation.duration = duration;
    
    CAAnimationGroup * outAnimation = [CAAnimationGroup animation];
    outAnimation.animations = @[outFlipAnimation, zTranslationAnimation];
