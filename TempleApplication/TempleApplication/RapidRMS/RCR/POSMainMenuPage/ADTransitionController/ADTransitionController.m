...
- (void)loadView {
    ...
    _navigationBar.items = items;

    _toolbar.items = [self.viewControllers.lastObject toolbarItems];
}
...
- (void)setNavigationBarHidden:(BOOL)hidden animated:(BOOL)animated {
    ...
    } else if (!self.navigationBarHidden && hidden) {
