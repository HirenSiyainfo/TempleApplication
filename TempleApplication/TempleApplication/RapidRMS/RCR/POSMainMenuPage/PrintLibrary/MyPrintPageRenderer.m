...
- (NSInteger)numberOfPages
{
  ...
  UIPrintFormatter *myFormatter = (UIPrintFormatter *)[self.printFormatters firstObject];
...
- (void)drawHeaderForPageAtIndex:(NSInteger)pageIndex inRect:(CGRect)headerRect
{
  if(self.jobTitle)
  {
    ...
    NSDictionary *textAttributes = @{NSFontAttributeName: [UIFont fontWithName:@"Helvetica" size:HEADER_FOOTER_TEXT_HEIGHT]};
   ...
   // [self.jobTitle drawAtPoint:startPoint withFont: font];
      ...
      [self.jobTitle drawAtPoint:startPoint withAttributes:textAttributes];
  }
}
...
- (void)drawFooterForPageAtIndex:(NSInteger)pageIndex inRect:(CGRect)footerRect 
{
 ...
 // CGSize pageNumSize = [pageNumberString sizeWithFont:font];
    ...
    CGSize pageNumSize = [pageNumberString sizeWithAttributes:textAttributes];
  ...
  //[pageNumberString drawAtPoint:startPoint withFont: font];
    ...
    [pageNumberString drawAtPoint:startPoint withAttributes:textAttributes];
}
