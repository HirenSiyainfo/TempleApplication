...
- (instancetype)initWithDefaults:(RasSpeed)speed endOfPageBehaviour:(RasPageEndMode)endOfPageBehaviour_m endOfDocumentBahaviour:(RasPageEndMode)endOfDocumentBehaviour_m topMargin:(RasTopMargin)topMargin_m pageLength:(int)pageLength_m leftMargin:(int)leftMargin_m rightMargin:(int)rightMargin_m
{
    self = [super init];
