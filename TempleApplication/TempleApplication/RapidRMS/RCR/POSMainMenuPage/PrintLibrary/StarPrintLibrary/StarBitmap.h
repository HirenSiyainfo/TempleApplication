...
- (instancetype)initWithUIImage:(UIImage *)image :(int)maxWidth :(bool)dithering NS_DESIGNATED_INITIALIZER;
- (void)dealloc;
...
@property (NS_NONATOMIC_IOSONLY, getter=getImageImpactPrinterForPrinting, readonly, copy) NSData *imageImpactPrinterForPrinting;
