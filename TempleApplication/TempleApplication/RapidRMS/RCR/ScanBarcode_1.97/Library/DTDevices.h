...
typedef NS_ENUM(unsigned int, BARCODES) {
	BAR_ALL=0, 
	BAR_UPC,
	BAR_CODABAR,
	BAR_CODE25_NI2OF5,
...
typedef NS_ENUM(unsigned int, BARCODES_EX) {
	BAR_EX_ALL=0, 
	BAR_EX_UPCA,
	BAR_EX_CODABAR,
 ...
 * Connection state
 */
typedef NS_ENUM(unsigned int, CONN_STATES) {
    /**
...
/**
 Barcode scan modes
 */
typedef NS_ENUM(unsigned int, SCAN_MODES) {
    /**
...
/**
 Button modes
 */
typedef NS_ENUM(unsigned int, BUTTON_STATES) {
    /**
     Button is disabled
     */
	BUTTON_DISABLED=0,
...
/**
 Card data mode
 */
typedef NS_ENUM(unsigned int, MS_MODES) {
    /**
 ...
 */
typedef NS_ENUM(unsigned int, FEAT_EMV2_KERNELS)
{
    /**
 ...
 */
typedef NS_ENUM(unsigned int, BT_MODES) {
    /**
 ...
 */
typedef NS_ENUM(unsigned int, UPDATE_PHASES) {
    /**
     Initializing update
     */
	UPDATE_INIT=0,
 ...
 */
typedef NS_OPTIONS(unsigned int, PIN_ENCRYPTION_FORMATS) {
    /**
...
typedef NS_ENUM(unsigned int, ICC_TYPES) {
	TYPE_ICC=0,
	TYPE_PIN,
};

typedef NS_ENUM(unsigned int, RSA_VERIFY_KEY) {
	KEY_ISSUER=0,
	KEY_ICC,
};
 ...
 */
typedef NS_ENUM(unsigned int, SC_SLOTS)
{
    /**
...
/**
 RF card types
 */
typedef NS_ENUM(unsigned int, RF_CARD_TYPES)
{
    /**
     Unknown card
     */
 ...
 */
typedef NS_ENUM(unsigned int, FELICA_SMARTTAG_BATERY_STATUSES)
{
    /**
 ...
 */
typedef NS_ENUM(unsigned int, FELICA_SMARTTAG_DRAW_MODES)
{
    /**
 ...
 */
typedef NS_ENUM(unsigned int, FEATURES)
{
    /**
...
/**
 Print protocols
 */
typedef NS_ENUM(unsigned int, FEAT_PRINT_PROTOCOLS)
{
    /**
 ...
 */
typedef NS_OPTIONS(unsigned int, FEAT_MSRS)
{
    /**
 ...
 */
typedef NS_ENUM(unsigned int, FEAT_BARCODES)
{
    /**
 ...
 */
typedef NS_ENUM(unsigned int, FEAT_BLUETOOTHS)
{
    /**
 ...
 */
typedef NS_ENUM(unsigned int, LANGUAGES) {
    /**
     English
     */
	LANG_ENGLISH=0,
 ...
 */
typedef NS_ENUM(unsigned int, CODEPAGES)
{
    /**
...
/**
 Display fonts
 */
typedef NS_ENUM(unsigned int, FONTS)
{
    /**
     6x8 pixels
     */
 ...
 */
typedef NS_OPTIONS(unsigned int, SCREEN_COLOR_MODES)
{
    /**
...
typedef NS_ENUM(unsigned int, APP_SELECTION_METHODS) {
	SELECTION_PSE=0,
	SELECTION_AIDLIST,
};

typedef NS_ENUM(unsigned int, APP_MATCH_CRITERIAS) {
	MATCH_FULL=1,
	MATCH_PARTIAL_VISA,
	MATCH_PARTIAL_EUROPAY,
};

typedef NS_ENUM(unsigned int, AUTH_RESULTS) {
...
typedef NS_ENUM(unsigned int, BYPASS_MODES) {
    BYPASS_CURRENT_METHOD_MODE=0,
    BYPASS_ALL_METHODS_MODE,
};

typedef NS_ENUM(unsigned int, CERTIFICATE_AC_TYPES) {
    CERTIFICATE_AAC=0,
    CERTIFICATE_TC,
    CERTIFICATE_ARQC,
};

typedef NS_ENUM(unsigned int, CARD_RISK_TYPES) {
    CDOL_1=1,
    CDOL_2,
};

typedef NS_ENUM(unsigned int, TAG_TYPES) {
    TAG_TYPE_BINARY=0,
    TAG_TYPE_BCD,
    TAG_TYPE_STRING,
};
 ...
 */
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL pageIsSupported;
/**
 ...
 */
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL tableIsSupported;
/**
