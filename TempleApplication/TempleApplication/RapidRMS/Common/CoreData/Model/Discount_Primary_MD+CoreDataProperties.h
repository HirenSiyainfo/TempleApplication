//
//  Discount_Primary_MD+CoreDataProperties.h
//  RapidRMS
//
...
@interface Discount_Primary_MD (CoreDataProperties)

@property (nullable, nonatomic, retain) NSDate *createdDate;
@property (nullable, nonatomic, retain) NSNumber *discountId;
@property (nullable, nonatomic, retain) NSNumber *primaryId;
...
@property (nullable, nonatomic, retain) Discount_M *primaryItem;
