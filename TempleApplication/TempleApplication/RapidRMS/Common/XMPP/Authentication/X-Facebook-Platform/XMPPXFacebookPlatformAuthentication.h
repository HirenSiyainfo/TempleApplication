...
**/
- (instancetype)initWithStream:(XMPPStream *)stream appId:(NSString *)appId accessToken:(NSString *)accessToken NS_DESIGNATED_INITIALIZER;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL supportsXFacebookPlatformAuthentication;
