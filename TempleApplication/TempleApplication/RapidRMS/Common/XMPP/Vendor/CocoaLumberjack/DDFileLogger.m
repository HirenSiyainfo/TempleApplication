...
- (void)deleteOldLogFiles
{
    ...
    if (count > 0)
    {
        DDLogFileInfo *logFileInfo = sortedLogFileInfos.firstObject;
...
- (NSString *)defaultLogsDirectory
{
    ...
    NSString *baseDir = (paths.count > 0) ? paths.firstObject : nil;
...
- (DDLogFileInfo *)currentLogFileInfo
{
    if (currentLogFileInfo == nil)
    {
        ...
        {
            DDLogFileInfo *mostRecentLogFileInfo = sortedLogFileInfos.firstObject;
