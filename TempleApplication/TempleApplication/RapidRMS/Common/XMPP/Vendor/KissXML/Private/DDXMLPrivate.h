...
- (instancetype)initWithNsPrimitive:(xmlNsPtr)ns nsParent:(xmlNodePtr)parent owner:(DDXMLNode *)owner NS_DESIGNATED_INITIALIZER;

@property (NS_NONATOMIC_IOSONLY, readonly) xmlNodePtr _nsParentPtr;
...
- (instancetype)initWithAttrPrimitive:(xmlAttrPtr)attr owner:(DDXMLNode *)owner NS_DESIGNATED_INITIALIZER;
...
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL _hasParent;
