...
- (instancetype)initWithdDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq resolverQueue:(dispatch_queue_t)rq
{
...
- (void)sortResults
{
	...
	while (results.count > 0)
	{
		...
		{
			XMPPSRVRecord *srvRecord = results.firstObject;
...
- (instancetype)initWithPriority:(UInt16)p1 weight:(UInt16)w port:(UInt16)p2 target:(NSString *)t
{
	if ((self = [super init]))
	{
		priority = p1;
