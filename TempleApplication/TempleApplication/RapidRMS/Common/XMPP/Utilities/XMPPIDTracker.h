...
- (instancetype)initWithStream:(XMPPStream *)stream dispatchQueue:(dispatch_queue_t)queue NS_DESIGNATED_INITIALIZER;
...
@property (NS_NONATOMIC_IOSONLY, readonly) NSUInteger numberOfIDs;
...
- (instancetype)initWithTarget:(id)target selector:(SEL)selector timeout:(NSTimeInterval)timeout NS_DESIGNATED_INITIALIZER;
- (instancetype)initWithBlock:(void (^)(id obj, id <XMPPTrackingInfo> info))block timeout:(NSTimeInterval)timeout NS_DESIGNATED_INITIALIZER;
