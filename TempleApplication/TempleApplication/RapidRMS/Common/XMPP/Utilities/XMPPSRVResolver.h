...
**/
- (instancetype)initWithdDelegate:(id)aDelegate delegateQueue:(dispatch_queue_t)dq resolverQueue:(dispatch_queue_t)rq NS_DESIGNATED_INITIALIZER;
...
- (instancetype)initWithPriority:(UInt16)priority weight:(UInt16)weight port:(UInt16)port target:(NSString *)target NS_DESIGNATED_INITIALIZER;
