...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, strong) DDListEnumerator *listEnumerator;
@property (NS_NONATOMIC_IOSONLY, readonly, strong) DDListEnumerator *reverseListEnumerator;
...
@property (NS_NONATOMIC_IOSONLY, readonly) NSUInteger numTotal;
@property (NS_NONATOMIC_IOSONLY, readonly) NSUInteger numLeft;

@property (NS_NONATOMIC_IOSONLY, readonly) void *nextElement;
