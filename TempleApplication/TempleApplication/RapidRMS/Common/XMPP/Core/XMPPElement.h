...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *elementID;

@property (NS_NONATOMIC_IOSONLY, readonly, copy) XMPPJID *to;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) XMPPJID *from;

@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *toStr;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *fromStr;
