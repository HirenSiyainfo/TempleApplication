...
**/
- (instancetype)initP2PFrom:(XMPPJID *)myJID NS_DESIGNATED_INITIALIZER;
...
**/
@property (readwrite, strong) id tagTemp;
...
**/
@property (NS_NONATOMIC_IOSONLY, getter=isConnecting, readonly) BOOL connecting;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL supportsStartTLS;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL supportsInBandRegistration;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *supportedAuthenticationMechanisms;
...
**/
@property (NS_NONATOMIC_IOSONLY, getter=isAuthenticating, readonly) BOOL authenticating;
 ...
 **/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSDate *authenticationDate;
 ...
 **/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *supportedCompressionMethods;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) DDXMLElement *rootElement;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly) float serverXmppStreamVersionNumber;
...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *generateUUID;
