...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) XMPPJID *bareJID;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) XMPPJID *domainJID;

@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *bare;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *full;

@property (NS_NONATOMIC_IOSONLY, getter=isBare, readonly) BOOL isBare;
@property (NS_NONATOMIC_IOSONLY, getter=isBareWithUser, readonly) BOOL bareWithUser;

@property (NS_NONATOMIC_IOSONLY, getter=isFull, readonly) BOOL isFull;
@property (NS_NONATOMIC_IOSONLY, getter=isFullWithUser, readonly) BOOL fullWithUser;

/**
 * A server JID does not have a user component.
**/
@property (NS_NONATOMIC_IOSONLY, getter=isServer, readonly) BOOL server;
