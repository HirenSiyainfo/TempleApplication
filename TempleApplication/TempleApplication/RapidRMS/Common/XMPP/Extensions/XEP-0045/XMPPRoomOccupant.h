...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *role;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *affiliation;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) XMPPJID *realJID;
