...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, strong) GCDMulticastDelegate *multicastDelegate;

@property (NS_NONATOMIC_IOSONLY, readonly, strong) dispatch_queue_t moduleQueue;
