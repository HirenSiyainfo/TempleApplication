...
- (instancetype)initWithIncomingMessage:(XMPPMessage *)message NS_DESIGNATED_INITIALIZER;
- (instancetype)initWithOutgoingMessage:(XMPPMessage *)message  jid:(XMPPJID *)myRoomJID NS_DESIGNATED_INITIALIZER;
