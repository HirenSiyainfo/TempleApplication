...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *messages;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *occupants;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *resortMessages;
 ...
 * If changed, this method should be invoked to force a resort.
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *resortOccupants;
