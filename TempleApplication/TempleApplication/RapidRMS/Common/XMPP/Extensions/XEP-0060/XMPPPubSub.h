...
**/
- (instancetype)initWithServiceJID:(XMPPJID *)aServiceJID;
- (instancetype)initWithServiceJID:(XMPPJID *)aServiceJID dispatchQueue:(dispatch_queue_t)queue NS_DESIGNATED_INITIALIZER;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *retrieveSubscriptions;
