 ...
 **/
- (instancetype)initWithDatabaseFilename:(NSString *)databaseFileName storeOptions:(NSDictionary *)storeOptions NS_DESIGNATED_INITIALIZER;

/**
 * Initializes a core data storage instance, backed by an in-memory store.
**/
- (instancetype)initWithInMemoryStore NS_DESIGNATED_INITIALIZER;
