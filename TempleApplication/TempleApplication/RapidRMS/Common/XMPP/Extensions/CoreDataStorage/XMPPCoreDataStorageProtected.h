...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *managedObjectModelName;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, strong) NSBundle *managedObjectModelBundle;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *persistentStoreDirectory;
...
**/
@property (NS_NONATOMIC_IOSONLY, readonly) NSUInteger numberOfUnsavedChanges;
