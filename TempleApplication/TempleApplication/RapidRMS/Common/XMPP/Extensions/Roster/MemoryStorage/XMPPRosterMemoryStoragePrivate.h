...
- (instancetype)initWithJID:(XMPPJID *)aJid;
- (instancetype)initWithItem:(NSXMLElement *)item;
...
- (instancetype)initWithPresence:(XMPPPresence *)aPresence;

- (void)updateWithPresence:(XMPPPresence *)presence;

@property (NS_NONATOMIC_IOSONLY, readwrite, copy) XMPPPresence *presence;
