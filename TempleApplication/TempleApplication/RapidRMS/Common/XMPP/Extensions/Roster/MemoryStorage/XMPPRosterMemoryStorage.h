...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) XMPPUserMemoryStorageObject *myUser;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) XMPPResourceMemoryStorageObject *myResource;

- (XMPPUserMemoryStorageObject *)userForJID:(XMPPJID *)jid;
- (XMPPResourceMemoryStorageObject *)resourceForJID:(XMPPJID *)jid;

@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *sortedUsersByName;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *sortedUsersByAvailabilityName;

@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *sortedAvailableUsersByName;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *sortedUnavailableUsersByName;

@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *unsortedUsers;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *unsortedAvailableUsers;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *unsortedUnavailableUsers;
