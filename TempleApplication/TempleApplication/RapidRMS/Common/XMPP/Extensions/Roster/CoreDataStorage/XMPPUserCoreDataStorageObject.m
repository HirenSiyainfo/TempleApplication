...
- (void)setSectionNum:(NSNumber *)sectionNum
{
  ...
  self.primitiveSectionNum = sectionNum;
...
{  
  ...
  self.primitiveDisplayName = displayName;
...
- (void)recalculatePrimaryResource
{
	...
	{
		XMPPResourceCoreDataStorageObject *resource = sortedResources.firstObject;
...
- (void)updateWithPresence:(XMPPPresence *)presence streamBareJidStr:(NSString *)streamBareJidStr
{
	...
	if ([presence.type isEqualToString:@"unavailable"] || presence.errorPresence)
	{
		if (resource)
		{
