...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *xmppDateString;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *xmppTimeString;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *xmppDateTimeString;
