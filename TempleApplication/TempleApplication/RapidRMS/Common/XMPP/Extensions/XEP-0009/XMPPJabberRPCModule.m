...
- (instancetype)initWithRpcID:(NSString *)rpcID timer:(dispatch_source_t)timer NS_DESIGNATED_INITIALIZER;
...
- (instancetype)initWithRpcID:(NSString *)aRpcID timer:(dispatch_source_t)aTimer
{
	if ((self = [super init]))
	{
		rpcID = [aRpcID copy];
