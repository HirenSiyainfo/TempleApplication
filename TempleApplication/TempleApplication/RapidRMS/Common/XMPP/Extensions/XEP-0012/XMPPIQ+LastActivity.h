 ...
 */
@property (NS_NONATOMIC_IOSONLY, getter=isLastActivityQuery, readonly) BOOL lastActivityQuery;
 ...
 */
@property (NS_NONATOMIC_IOSONLY, readonly) NSUInteger lastActivitySeconds;
 ...
 */
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *lastActivityUnavailableStatus;
