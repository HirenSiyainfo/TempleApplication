...
- (instancetype)initWithMessageArchivingStorage:(id <XMPPMessageArchivingStorage>)storage;
- (instancetype)initWithMessageArchivingStorage:(id <XMPPMessageArchivingStorage>)storage dispatchQueue:(dispatch_queue_t)queue NS_DESIGNATED_INITIALIZER;
