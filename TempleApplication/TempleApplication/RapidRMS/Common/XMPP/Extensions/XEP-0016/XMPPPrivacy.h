...
**/
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *listNames;
...
**/
@property (NS_NONATOMIC_IOSONLY, copy) NSString *activeListName;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *activeList;
