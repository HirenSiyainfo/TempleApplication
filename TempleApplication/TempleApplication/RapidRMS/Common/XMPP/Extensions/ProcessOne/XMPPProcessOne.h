 ...
 * }
**/
@property (NS_NONATOMIC_IOSONLY, readonly, strong) XMPPElementReceipt *goOnStandby;
@property (NS_NONATOMIC_IOSONLY, readonly, strong) XMPPElementReceipt *goOffStandby;
...
- (instancetype)initWithStream:(XMPPStream *)stream sessionID:(NSString *)sessionID sessionJID:(XMPPJID *)sessionJID NS_DESIGNATED_INITIALIZER;
...
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL supportsPush;
@property (NS_NONATOMIC_IOSONLY, readonly) BOOL supportsRebind;

@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *rebindSessionID;
