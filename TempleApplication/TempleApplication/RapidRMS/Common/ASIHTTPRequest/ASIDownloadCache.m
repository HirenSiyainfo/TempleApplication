...
- (instancetype)init
{
	...
	self.defaultCachePolicy = ASIReloadIfDifferentCachePolicy;
...
+ (ASIDownloadCache*)sharedCache
{
	if (!sharedCache) {
		...
		sharedCache.storagePath = [NSTemporaryDirectory() stringByAppendingPathComponent:@"ASIHTTPRequestCache"];
