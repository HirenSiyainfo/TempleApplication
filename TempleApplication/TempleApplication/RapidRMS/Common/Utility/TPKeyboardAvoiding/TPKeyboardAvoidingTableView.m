...
@interface TPKeyboardAvoidingTableView () <UITextFieldDelegate, UITextViewDelegate,NSFileManagerDelegate> {
...
@property (NS_NONATOMIC_IOSONLY, readonly) UIEdgeInsets contentInsetForKeyboard;
- (CGFloat)idealOffsetForView:(UIView *)view withSpace:(CGFloat)space;
@property (NS_NONATOMIC_IOSONLY, readonly) CGRect keyboardRect;
@end
...
//    [UIView beginAnimations:nil context:NULL];
    ...
    self.contentInset = self.contentInsetForKeyboard;
    [self setContentOffset:CGPointMake(self.contentOffset.x,[self idealOffsetForView:firstResponder withSpace:self.keyboardRect.origin.y - self.bounds.origin.y])
                  animated:YES];
