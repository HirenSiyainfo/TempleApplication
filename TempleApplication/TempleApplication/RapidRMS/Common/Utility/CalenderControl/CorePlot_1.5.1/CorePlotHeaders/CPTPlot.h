 ...
 **/
-(double *)doublesForPlot:(CPTPlot *)plot field:(NSUInteger)fieldEnum recordIndexRange:(NSRange)indexRange NS_RETURNS_INNER_POINTER;
...
/// @name Legends
/// @{
@property (NS_NONATOMIC_IOSONLY, readonly) NSUInteger numberOfLegendEntries;
...
/// @name Fields
/// @{
@property (NS_NONATOMIC_IOSONLY, readonly) NSUInteger numberOfFields;
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *fieldIdentifiers;
