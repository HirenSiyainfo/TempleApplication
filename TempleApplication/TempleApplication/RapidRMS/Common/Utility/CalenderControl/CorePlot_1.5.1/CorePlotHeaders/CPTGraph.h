...
/// @{
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *allPlots;
...
/// @{
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSArray *allPlotSpaces;
...
/// @{
@property (NS_NONATOMIC_IOSONLY, readonly, strong) CPTPlotSpace *newPlotSpace;
@property (NS_NONATOMIC_IOSONLY, readonly, strong) CPTAxisSet *newAxisSet;
/// @}
