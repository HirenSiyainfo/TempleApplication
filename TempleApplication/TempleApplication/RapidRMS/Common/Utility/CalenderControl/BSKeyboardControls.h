 ...
 *  Available controls.
 */
typedef NS_OPTIONS(unsigned int, BSKeyboardControl)
{
 ...
 */
typedef NS_ENUM(unsigned int, BSKeyboardControlsDirection)
{
 ...
 */
- (instancetype)initWithFields:(NSArray *)fields NS_DESIGNATED_INITIALIZER;
