...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = self.suggestionOptions[indexPath.row];
...
{
    self.textField.text = self.suggestionOptions[indexPath.row];
...
//    NSArray *tempArr = [[NSArray alloc] initWithObjects:[self.suggestionOptions objectAtIndex:indexPath.row], nil];
//    [tagList setTags:tempArr];
