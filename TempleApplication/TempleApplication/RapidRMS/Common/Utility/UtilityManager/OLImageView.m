...
{
    if (self.currentFrameIndex >= self.animatedImage.images.count && self.animatedImage.partial) {
        return;
    }
...
- (void)displayLayer:(CALayer *)layer
{
    ...
    layer.contents = (__bridge id)((self.animatedImage.images)[self.currentFrameIndex].CGImage);
}
