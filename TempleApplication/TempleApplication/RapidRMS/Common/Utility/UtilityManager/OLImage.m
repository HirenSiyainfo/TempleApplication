...
- (instancetype)initWithCGImageSource:(CGImageSourceRef)imageSource scale:(CGFloat)scale
{
    ...
    NSDictionary *gifProperties = imageProperties[(NSString *)kCGImagePropertyGIFDictionary];
...
- (CGSize)size
{
    if (self.images.count) {
        return self.images.firstObject.size;
    }
    return super.size;
}
...
- (void)updateCount
{
    ...
    self.frameCache.countLimit = cacheLimit;
}
