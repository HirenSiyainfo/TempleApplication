...
/*!
 ...
 @discussion
 */
typedef NS_OPTIONS(unsigned int, FBSessionState) {
 ...
 */
typedef NS_ENUM(unsigned int, FBSessionLoginBehavior) {
 ...
 */
typedef NS_ENUM(unsigned int, FBSessionDefaultAudience) {
 ...
 */
typedef NS_ENUM(unsigned int, FBSessionLoginType) {
